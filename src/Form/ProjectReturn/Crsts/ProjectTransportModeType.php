...
class ProjectTransportModeType extends AbstractType implements DataMapperInterface
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('transportModeCategory', ChoiceType::class, [
                'label' => 'forms.project.transport_mode.category.label',
                'label_attr' => ['class' => 'govuk-fieldset__legend--s'],
                'help' => 'forms.project.transport_mode.category.help',
                'choices' => $categories,
        ...
        foreach($categories as $category) {
            ...
            $builder->add('transportMode'.ucfirst($category->value), ChoiceType::class, [
                'label' => "forms.project.transport_mode.{$category->value}.label",
                'label_attr' => ['class' => 'govuk-fieldset__legend--s'],
                'help' => "forms.project.transport_mode.{$category->value}.help",
                'choices' => $choices,
