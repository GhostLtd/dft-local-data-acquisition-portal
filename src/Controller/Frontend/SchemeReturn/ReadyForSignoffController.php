...
class ReadyForSignoffController extends AbstractReturnController
{
    ...
    public function __construct(
        ...
        WorkflowInterface                    $completionStateStateMachine,
        protected DashboardBreadcrumbBuilder $breadcrumbBuilder,
    )
    {
        parent::__construct($entityManager, $completionStateStateMachine);
    }
    ...
    ): Response
    {
        ...
        if ($type === self::MARK_AS_READY) {
            $this->denyAccessUnlessGranted(Role::CAN_SIGN_OFF_SCHEME, $schemeReturn);
            ...
            $this->denyAccessUnlessGranted(Role::CAN_REOPEN_SCHEME, $schemeReturn);
