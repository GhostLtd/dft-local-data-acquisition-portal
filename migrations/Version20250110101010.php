...
final class Version20250110101010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE crsts_scheme_return (total_cost NUMERIC(12, 0) DEFAULT NULL, agreed_funding NUMERIC(12, 0) DEFAULT NULL, on_track_rating VARCHAR(255) DEFAULT NULL, business_case VARCHAR(255) DEFAULT NULL, expected_business_case_approval DATE DEFAULT NULL, progress_update LONGTEXT DEFAULT NULL, expense_division_comments JSON DEFAULT NULL, benefit_cost_ratio_value NUMERIC(10, 2) DEFAULT NULL, benefit_cost_ratio_type VARCHAR(5) DEFAULT NULL, id BINARY(16) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('ALTER TABLE scheme_return ADD CONSTRAINT FK_7CB99FA765797862 FOREIGN KEY (scheme_id) REFERENCES scheme (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE scheme_return DROP FOREIGN KEY FK_7CB99FA765797862');
