...
final class Version20250704094615 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Update export_scheme_return_data to use the property change log for scheme data, and add is_scheme_new field';
    }
...
SELECT
    ...
    , scheme_changes->>'$."crstsData.retained"' AS is_retained
    , is_development_only
    ...
    , scheme_changes->>'$."crstsData.previouslyTcf"' AS was_previously_tcf
    , type
    , risks
